                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/dribbble.svg" width="200" height="56" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
                                e o design digital de alto impacto.
                              </p>
                            </div>
                          </CommonCardBatchAnimated>
                          <CommonCardBatchAnimated
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/logitech.svg" width="200" height="60" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/envato.svg" width="700" height="169" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/crewai.svg" width="200" height="53" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/deepseek.svg" width="665" height="148" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/mozilla.svg" width="200" height="48" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
                        ...
                        <div className="row g-0">
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/udemy.svg" width="200" height="75" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/angular.svg" width="200" height="49" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
                          ...
                          >
                            <div className="mxd-clients__logo">
                              ...
                              {/* <Image   alt="MINDSITE Template Image Example"    src="/img/brands/ghostgaming.svg" width="200" height="84" /> */}
                            </div>
                            <div className="mxd-clients__descr">
                              <p className="t-medium">
                                Colaborações estratégicas para impulsionar a inovação
