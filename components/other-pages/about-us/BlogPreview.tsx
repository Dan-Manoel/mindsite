                  ...
                  <div className="row g-0 mxd-blog-grid__gallery">
                      ...
                      <div className="mxd-blog-item__caption">
                        <div className="mxd-blog-item__title">
                          <Link className="blog-name-s" href={`/blog-article`}>
                            Inovações no Frontend e a jornada do usuário
                          </Link>
                        </div>
                      </div>
                    </CommonCardBatchAnimated>
                    ...
                    >
                      ...
                      <div className="mxd-blog-item__caption">
                        <div className="mxd-blog-item__title">
                          <Link className="blog-name-s" href={`/blog-article`}>
                            A importância do Branding nas experiências digitais
                          </Link>
                        </div>
                      </div>
                    </CommonCardBatchAnimated>
                    ...
                    >
                      ...
                      <div className="mxd-blog-item__caption">
                        <div className="mxd-blog-item__title">
                          <Link className="blog-name-s" href={`/blog-article`}>
                            Aprimorando workshops digitais com um design envolvente
                          </Link>
                        </div>
                      </div>
                    </CommonCardBatchAnimated>
